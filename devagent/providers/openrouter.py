...
from devagent.providers.base import register
from devagent.providers.openai import OpenAIProvider

logger = logging.getLogger(__name__)
_MODEL_CACHE: dict[str, int] = {}
_HEADERS = {"HTTP-Referer": "https://github.com/devagent/devagent", "X-Title": "DevAgent"}
